...
import br.com.product.productapi.modules.supplier.dto.SupplierRequest;
import br.com.product.productapi.modules.supplier.dto.SupplierResponse;
...
public class SupplierService {
    ...
    private void validateSupplierNameInformed(SupplierRequest request) {
        if(isEmpty(request.getName())) {
            throw new ValidationException("The supplier's was not informed.");
        }
    }
    ...
    public SuccessResponse delete(Integer id) {
        ...
        if (productService.existsBySupplierId(id)) {
            throw new ValidationException("You cannot delete this supplier because it's " +
                                          "already defined by a product.");
        }
